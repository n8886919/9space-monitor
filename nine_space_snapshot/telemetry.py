...
The app retains no telemetry history. Outbound batches only live in a
...
class UrllibCenterClient:
    ...
    async def post(self, url: str, payload: dict[str, Any], timeout_seconds: float) -> None:
        ...
        def _send() -> None:
            ...
            with urlopen(request, timeout=timeout_seconds) as response:  # noqa: S310 - URL is local app config
